...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("\nТест 2: Бронь +1 (Макс, 12:00 - 16:00)");
        ...
        Console.WriteLine("\nТест 3: Вывод информации о столе");
        table1.PrintTableInfo();
        
        Console.WriteLine("\nТест 4: Бронь (Анна, 13:00 - 14:00)");
        var booking2 = Booking.CreateBooking(1, "Анна", "50000", "13:00", "14:00", "Встреча", 2);
        ...
        Console.WriteLine("\nТест 5: Бронь (Анна, 16:00 - 17:00)");
        var booking3 = Booking.CreateBooking(1, "Анна", "50000", "16:00", "17:00", "Встреча", 2);
        if (!table1.BookTable(booking3.StartTime, booking3.EndTime, $"{booking3.ClientName} (ID: {booking3.ClientId}, Телефон: {booking3.ClientPhone})"))
        {
        ...
        Console.WriteLine("\nТест 6: Вывод информации о столе ");
        table1.PrintTableInfo();

        Console.WriteLine("\nТест 7: Редактирование стола (1)");
        if (table1.Schedule.ContainsKey("12:00-13:00")){
            table1.UpdateTableInfo("у Выхода", 6);
            Console.WriteLine("x Редактирование стола (1) (Ошибка: есть активные брони)");
        }
        Console.WriteLine("\nТест 8: Поиск бронирования (Макс, 0000)");
